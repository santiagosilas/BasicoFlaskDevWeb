...
class GerenciarUsuarios:
    def __init__(self):
        ...
        u_1 = Usuario('Abel', '(88) 8888-8888', 'abel@gmail.com', 'M', 'Rua 51', 21, 151, '1234', '1981-08-01',
                      'casado', True)
        u_2 = Usuario('Joseph', '(88) 8888-8888', 'joseph@gmail.com', 'M', 'Rua 42', 22, 152, '1234', '1985-08-01',
                      'viúvo', True)
        u_3 = Usuario('Maria', '(88) 8888-8888', 'maria@gmail.com', 'F', 'Rua 33', 23, 153, '1234', '1991-08-01',
                      'solteiro', True)
        u_4 = Usuario('Eva', '(88) 8888-8888', 'eva@gmail.com', 'F', 'Rua 24', 24, 154, '1234', '1995-11-01', 'casado',
                      True)
        u_5 = Usuario('Frank', '(88) 8888-8888', 'frank@gmail.com', 'M', 'Rua 15', 25, 155, '1234', '2001-08-01',
                      'solteiro', True)
